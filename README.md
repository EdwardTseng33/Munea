...
| App shell | App Store delivery | Capacitor iOS `1.0.3 (6)` is the current release target; Mac archive, IPA, and Edward iPhone installation are required release gates |
