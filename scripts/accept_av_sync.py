...
判準（v1 · 依 8/13 手術前後的實測校準）：
  ...
  ② 整輪中位 ≤ 300ms（整體體感）
  ③ 天花板：任何一段 ≤ 1200ms（術前病灶最重 1351ms 仍會被抓。
     2026-08-18 依真數據校準：第二刀 fast-first＋拆 VIDEO_LEAD -350 拐杖後
     輪首 skew ≤31ms、中段全淨；剩「輪中停頓後的最後一小段」健康態實測
     500-1100ms＝聲音不等畫面（Edward 拍板鐵律）而畫面生成要 0.5-0.6s。
     要再壓要動「輪界聲音微等 0.3-0.4s」＝鐵律例外、須 Edward 拍板。
     病的形狀由①中段＋④成叢抓；天花板只抓單段離譜。）
