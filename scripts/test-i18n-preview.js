...
assert(html.includes('../web/src/i18n/app-renderer-copy.js'));
assert(html.includes('MuneaAppRendererCopy.createAppRendererCopy'));
assert(html.includes('rendererCopy.queueCard'));
assert(html.includes('rendererCopy.walkActivity'));
assert(html.includes('rendererCopy.upcomingVisit'));
assert(html.includes('rendererCopy.planSummary'));
