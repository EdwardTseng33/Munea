(function () {
  ...
  const templates = {
    'nening-real-female': template({
      ...
      templateLabelFallback: t('companion.nening.label', '溫柔型 · 像家人，會照看'),
    ...
    'companion-real-male': template({
      ...
      templateLabelFallback: t('companion.ahong.label', '沉穩型 · 像大哥，很可靠'),
    ...
    'munea-2d-xiaoyun': template({
      ...
      templateLabelFallback: t('companion.xiaoyun.label', '開朗型 · 像朋友，很有朝氣'),
    ...
    'munea-2d-ayuan': template({
      ...
      templateLabelFallback: t('companion.ayuan.label', '隨和型 · 鄰家感，好聊天'),
    ...
    'munea-2d-mimi': template({
      ...
      templateLabelFallback: t('companion.mimi.label', '貓咪型 · 陪伴感，有個性'),
    ...
    'munea-2d-wangcai': template({
      ...
      templateLabelFallback: t('companion.wangcai.label', '狗狗型 · 熱情，很黏人'),
