...
| 候選 IPA | 54,674,528 bytes；SHA-256 `7e9562de4c9e1efdb0ca5044e17d54310acd00d6a82b9b8e979f76bd35693d45` |
| iOS 最低版本 | iOS 15 |
...
- ✅ PASS：以 `main@aedca6c` 為功能來源，PR #29 點數週期規則與 PR #23 語音開場緩衝／台語安全閘已和既有帳號、Call Control、登入及拍照修正同步；Web 與 iOS 內嵌資源一致。
...
- ✅ PASS：Build 10 Release Archive 與 App Store IPA 已依最新合併來源重建；正式 IPA 沒有測試帳號、假資料、自動登入或開發直連，並驗證簽章、版本／Build、Bundle ID、相機／照片用途說明、HealthKit、Apple 登入 entitlement 與最新設計資源。
