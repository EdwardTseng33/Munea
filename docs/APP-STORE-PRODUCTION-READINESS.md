...
| 候選 IPA | 54,671,339 bytes；SHA-256 `c8730d286d52f84197479548b0101361414f8fc707fde8574cb3e6288fc6eb67` |
| iOS 最低版本 | iOS 15 |
...
- ✅ PASS：`origin/main@c945150` 的最新版首頁／設定與帳號卡設計已同步，Web 與 iOS 內嵌資源雜湊一致；桌面與手機寬度無水平溢出。
- ✅ PASS：`1.0.4 (Build 9)` 測試版已覆蓋安裝到 Edward iPhone 15 Pro；版本查詢、安裝與啟動通過，測試帳號顯示 Pro、1,000 點與三位家人假資料。
- ✅ PASS：Build 9 Release Archive 與 App Store IPA 已在合併 PR #20 後重新匯出；正式 IPA 確認沒有測試帳號、假資料或自動登入，並驗證簽章、版本／Build、Bundle ID、相機／照片用途說明、HealthKit、Apple 登入 entitlement 與最新設計資源。
