...
- ✅ PASS：`1.0.3 (Build 6)` 已完成 Capacitor sync、Xcode 真機編譯、簽章 Archive、App Store IPA 匯出。
- ✅ PASS：IPA 版本、Build、Bundle ID、HealthKit entitlement、免加密聲明及登入回跳網址。
- ✅ PASS：`1.0.3 (Build 6)` 已覆蓋安裝到 Edward iPhone 15 Pro；一般啟動與登入回跳啟動均未閃退。
...
- ❌ FAIL：尚未確認 App Store Connect 的 `1.0.3 (Build 6)` 是否可上傳且未被使用。
...
5. 查 App Store Connect `1.0.3 (Build 6)` 可用性後再上傳。
