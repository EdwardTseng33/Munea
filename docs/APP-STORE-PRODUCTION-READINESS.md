...
此表為 2026-07-17 Edward 拍板版（PR #172 · 1.0.39）：Plus/Pro 月費不變、贈點改 100/200（每分鐘 6 元錨）；點數包一律貴過訂閱（訂閱含功能價值、點數是純加分鐘）。舊文件中的 150/300 贈點、200／400 點或其他價格皆已失效。

| 方案 | 價格 | 每月贈點 |
|---|---:|---:|
| Free | NT$0 | 綁定帳號後一次性 5 點 |
| Plus 月繳 | NT$599 | 100 點 |
| Plus 年繳 | NT$5,750 | 每月 100 點 |
| Pro 月繳 | NT$1,199 | 200 點 |
| Pro 年繳 | NT$11,500 | 每月 200 點 |

| 加購 | 價格 | 既有 App Store Product ID |
|---:|---:|---|
| 100 點 | NT$790 | `net.munea.app.points.200` |
| 300 點 | NT$2,190 | `net.munea.app.points.500` |
| 600 點 | NT$4,190 | `net.munea.app.points.1000` |
| 1,000 點 | NT$6,490 | `net.munea.app.points.1800` |
