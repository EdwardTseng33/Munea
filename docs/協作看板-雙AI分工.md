...
- ✅ **Repo／版本 PASS**：`origin/main@d0215a3`、iOS 功能分支與 Voice／Avatar canary 分支已完整納入；分支同步命名為 `codex/release-integration-1.0.9`。npm、版本頁、Xcode Debug／Release 與測試資料標記一致為 `1.0.9 (Build 14)`。
