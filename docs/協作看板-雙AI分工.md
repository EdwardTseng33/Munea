...
- **2026-07-21 Demo 1.0.3 單次解鎖**：B2B Demo 不再把明文密語或解鎖旗標留在 `sessionStorage`；掛斷、體驗結束、關閉或離開頁面時清除 Demo Avatar／Voice 臨時憑證，下一次測試必須重新輸入密語。範圍只含 `munea-b2b`，未修改 App 服務、正式角色或 App 生成設定。
