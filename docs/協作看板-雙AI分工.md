...
- **來源／隔離**：以最新 `origin/main@e1ab552` 建立獨立 worktree `/private/tmp/munea-package-1.0.14` 與分支 `codex/package-1.0.14`；共享 dirty main 不切換、不清理、不覆蓋。目前 GitHub 沒有開啟中的 PR，無同檔衝突。
