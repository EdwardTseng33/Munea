...
- **任務／來源**：獨立 worktree `codex/app-store-1.0.46-build1-post284-20260729`，最終基準 `origin/main@ba19301`。已納入 #284 四語 App foundation、#314 全螢幕／用藥餐別／家人空狀態、#315 Apple 健康誠實空值、#317 登入鍵／字體視覺修正與 #321 Voice／Avatar 同線回退修正；同時包含通話前置並行與 Avatar ICE 候選提早送出。因此建立新成品，不沿用 1.0.45 Build 1 的 package／手機／Apple 證據。
...
- **22:39 實際結果**：#284 已合併（`fa9907f`），打包期間 #317、#321 又進 main，因此所有較早本機成品均已作廢；最終發版綁定 GitHub 可追溯 commit `496107f`。完整 `test:launch`、strict iOS 1.0.46 (1)、Call Control 15/15、Avatar、四語 foundation／release gates、產品對齊、Archive／IPA 防漏 PASS；#321 後關鍵 gates 再跑 PASS。第一次 IPA export 正確攔下「export gate 與 release manifest 語系開關互相矛盾」；修為只打包 `binaryLocalizationEnabled` 語系，英／日／西仍在真人／法規／商店素材 Gate 後，未提前對外宣稱支援。最終 IPA 59,021,933 bytes，SHA-256 `66c64d645f27f9c691ea1760523a6737d868d3ce3f3f1cfc572b02497e1171b0`。
- **手機／Apple**：Edward iPhone 15 Pro 已安裝、啟動並回讀 `1.0.46 (1)`；Development signing＋production config，無 QA fixture，packaged build identity=`496107f`。App Store Connect upload 尚未發生：系統在外送此私有 binary 前要求 Edward 對精確成品再次明確核准；latest uploaded／selected 仍是 1.0.45 Build 1。
