...
- **Codex鎖區**：只操作本輪新開的RunPod RTX 5090與獨立benchmark／結果文件；模型固定SoulX-FlashHead Lite commit `9bc03de39e1363b18e587d29b286708e1174dba9`，使用a05／a06、同一音檔與真`768x768x3`輸出。
