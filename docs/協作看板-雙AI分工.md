...
- ✅ **PR 整合狀態**：`#73`、`#74` 已合併 `main`；`#76` 的活動文案功能已整合進本候選；`#75` 的 GoogleSignIn 9.1.0、正式 iOS Client ID、callback scheme 與原生 bridge 已整合並通過 Xcode 編譯。原 `#75`、`#76` 尚未標成合併，待本整合 PR 進 `main` 後關閉為 superseded，因此目前仍不得宣稱全部 PR 已合併。
