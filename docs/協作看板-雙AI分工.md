...
- **來源基準**：已先合併最新 `origin/main@364412d`，納入 PR #14 的設定頁／首頁 UIUX 新設計與後續官網路由修正；不用舊 Web 資源直接重包。
...
- ✅ **來源／設計 PASS**：已合併 `origin/main@364412d`；Web 與 iOS 的首頁、設定、登入資源雜湊一致，PR #14 新設計已進本次兩份包。
...
- 📦 **正式成品**：`.tools/xcode-exports/app-store/App.ipa`，52 MB，SHA-256 `b49032b654f2045278fab629603d6cf8dc7a74c377a8226bd63f921948539e1c`。
...
- ⏳ **Repo**：沿用 `codex/fix-auth-camera-1.0.3` 與 Draft PR #18，完成本次提交後推送更新；未碰共享 dirty `main`。
