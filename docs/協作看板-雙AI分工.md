...
- **帳面同步**：馬魯克回填 `STATUS.md`（129 號）／`docs/RELEASE-STATE.md` Runtime services／`supabase/deployment-ledger.json`，`test:supabase-governance`＋`test:product-alignment` 皆 PASS。不影響包版（本輪純部署與帳面，未動 App／`web/` 檔案）。
