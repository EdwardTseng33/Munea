...
- ✅ **正式 IPA PASS**：測試帳號、假資料、自動登入與開發直連均未進正式包；簽章、`1.0.5 (10)`、Bundle ID、相機／相簿說明、HealthKit 與 Apple 登入 entitlement 通過。唯一有效 IPA 為 54,781,117 bytes，SHA-256 `47c324464d483b8d01753f5840210029050a5d5e1a65aac8a81d6072679a8848`。
