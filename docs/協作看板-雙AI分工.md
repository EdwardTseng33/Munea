...
- **修改範圍**：只更新 `web/src/auth-config.js` 的 browser-safe 東京 URL／publishable key、版本 `1.0.10 (Build 15)`、iOS development fixture marker、`STATUS.md` 與本看板；不修改 backend env、部署腳本、RunPod 或 GLOWS。
