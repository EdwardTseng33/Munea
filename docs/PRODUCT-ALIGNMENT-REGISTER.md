...
更新：`2026-07-29 Asia/Taipei`

來源基準：`origin/main@68956b3` + `codex/app-store-1.0.45-build1-20260729`
...
| App Store lane | latest uploaded／selected `1.0.45 (Build 1)` | Apple processing 完成；App Store Connect 標題與版本欄位均為 1.0.45，Build 1 已選入並儲存，更新說明已優化。未送審／核准／公開 | `partial` | 精確候選 Build 通過真人 Gate 後再決定是否送審；後續 1.0.45 候選只遞增 Build number |
