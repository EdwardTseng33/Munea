...
|---|---|---|---|---|
| Latest source | `1.1.0 (Build 49)` | `origin/main` 的 package、lockfile、Web changelog、iOS Debug／Release與品質治理一致；#181–#199 已完成 API、release evidence、SLO 與輕量治理主線，本輪沒有 Build 48 Archive、upload 或 iPhone 安裝證據 | `package.json`; `web/src/version.js`; Xcode project; PR #176–#199 | 2026-07-20 |
