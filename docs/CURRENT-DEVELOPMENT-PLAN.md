...
> **Current source:** `1.0.45 (Build 493)`; source-only bump, not yet archived or uploaded. The frozen uploaded binary remains `1.0.44 (Build 492)` at `72a0bd46`, and its acceptance evidence does not carry to 1.0.45.
>
