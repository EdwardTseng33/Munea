...
> **Current source:** `1.0.67 (Build 538)`; the unique candidate keeps the call in connecting state until microphone, Voice, and Avatar audio are truly ready, closes the first live utterance after 650 ms of silence, prevents long-call lip-frame deletion, and upscales native 512 inference to 640 output. PR #581 and 0% candidates are not production; Build 538 still needs Mac Archive, exact-IPA identity checks, and installed-App acceptance before submission.
>
