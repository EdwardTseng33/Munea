...
> **Current source:** `1.0.46 (Build 1)` at exact GitHub packaged commit `222c650` (main through #317); Archive／IPA and Edward iPhone install／launch／version readback pass. Apple upload is pending explicit approval for this exact binary.
>
...
| App source / package | `1.0.46 (Build 1)` exact GitHub commit `222c650`; Archive／IPA and Edward iPhone readback pass; App E2E pending | `packaged and installed; human call gate pending` |
