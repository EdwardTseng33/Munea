...
| 證據 | 2026-07-20 判讀 |
|---|---|
| Latest source | `1.0.45 (Build 500)`；純 source 升版、尚未打包，Build number 跳到 500（492 之後 Edward 又包過幾版，實際上傳號待確認，跳號避免撞號）。current source 已遠超凍結 commit `72a0bd46`，沒有適用此版的 Archive／IPA 或 iPhone 證據 |
