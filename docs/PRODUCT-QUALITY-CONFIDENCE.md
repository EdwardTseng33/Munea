...
| App Store | `iOS App 版本 1.0.45` 已建立；Build 1 processing 完成、已選入並儲存，更新說明已優化。未送審／核准／公開 |
