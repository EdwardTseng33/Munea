...
| 證據 | 2026-07-20 判讀 |
|---|---|
| Latest source | `1.0.46 (Build 1)` exact GitHub commit `222c650`；Archive／IPA 防漏與 Edward iPhone 安裝／啟動／回讀 PASS，App E2E pending |
| Latest uploaded App | `1.0.45 (Build 1)`；Apple processing／版本頁選取已成立。1.0.46 upload 待精確成品核准 |
