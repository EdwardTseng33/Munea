...
| 證據 | 2026-07-20 判讀 |
|---|---|
| Latest source | `1.0.45 (Build 1)`；由 `origin/main@68956b3` 建立的發版候選，尚無 Archive／IPA 或 iPhone 證據 |
