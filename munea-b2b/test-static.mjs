...
assert.match(call, /Live\.releaseLocalPlayout\(\)/);
assert.match(call, /lossy trans-Pacific WebRTC audio muted/);
...
assert.match(call, /overlayTop: '9\.895833%'/);
assert.match(call, /overlayTop: '10\.885417%'/);
